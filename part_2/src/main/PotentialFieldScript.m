...
%% преобразование рассто€ни€

% подробнее -- см. help bwdist
d = bwdist(obstacle);

% масштабирование и преобразование рассто€ни€
...
%% визуализаци€ "оттлакивающей" компоненты
...
%% вычисление и визуализаци€ "прит€гивающей" компоненты
...
%% визуализаци€ пространства конфигураций
...
%% сложение двух компонент и визуализаци€ потенциального пол€
...
%%  визуализаци€ скатывающегос€ м€чика
...
%% визуализаци€ векторного пол€ градиента
[gx, gy] = gradient(-f);
skip = 20;
...
ps = plot(start(1), start(2), 'r.', 'MarkerSize', 20);
pg = plot(goal(1), goal(2), 'g.', 'MarkerSize', 20);
p3 = plot(route(:,1), route(:,2), 'm', 'LineWidth', 1);
